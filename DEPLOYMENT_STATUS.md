...
3. Paste code from `~/OPENBRAIN/openBrain/integrations/google-apps-script/OpenBrainSync.gs`
...
- `~/OPENBRAIN/openBrain/GOOGLE_CLOUD_SETUP.md` - Detailed setup guide
- `~/OPENBRAIN/openBrain/GOOGLE_WORKSPACE_DEPLOYMENT_CHECKLIST.md` - Full deployment guide
