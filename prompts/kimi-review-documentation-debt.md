...
1. ~/OPENBRAIN/openBrain/docs/status/ROADMAP.md
2. ~/OPENBRAIN/openBrain/docs/process/HANDOVER.md
...
12. ~/OPENBRAIN/openBrain/docs/status/PROGRESS_LOG.md
13. ~/OPENBRAIN/openBrain/docs/architecture/DATA-INTAKE-ARCHITECTURE.md
14. ~/OPENBRAIN/openBrain/docs/architecture/TSM-ORGANIZATIONAL-FRAMEWORK.md
...
3. docs/architecture/DATA-INTAKE-ARCHITECTURE.md — How data enters
4. docs/architecture/TSM-ORGANIZATIONAL-FRAMEWORK.md — How data is organized
