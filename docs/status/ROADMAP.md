...
**See:** `docs/status/PROGRESS_LOG.md` for detailed session logs
...
**Location:** `~/OPENBRAIN/openBrain/apps/dashboard/app/api/reclaim/smart-schedule/`
...
**Location:** 
- API: `~/OPENBRAIN/openBrain/apps/dashboard/app/api/incented/`
- UI: `~/OPENBRAIN/openBrain/apps/dashboard/src/features/incented/components/IncentedStatus.tsx`
...
- [x] Apps Script built — triggers email-ingest every 15 min (integrations/google/apps-script/gmail-apps-script.js)
- [x] email-ingest Edge Function — full Gmail API, keyword classification, incremental sync, OB-processed label
- [x] email_items table — migration 008_google_workspace_integration.sql
...
- [ ] Document Incented concepts and Open Brain mapping (see `docs/architecture/INCENTED-INTEGRATION.md`)
...
**Location:** `~/OPENBRAIN/openBrain/docs/architecture/INCENTED-INTEGRATION.md`
...
**Location:** `~/OPENBRAIN/openBrain/docs/architecture/INCENTED-IDIRNET-INTEGRATION.md`
...
### Critical Blockers
1. **Dashboard env vars** — Add to `apps/dashboard/.env.local`:
...
| This roadmap | ~/OPENBRAIN/openBrain/docs/status/ROADMAP.md |
