...
MUST READ:
- ~/OPENBRAIN/openBrain/docs/INCENTED-INTEGRATION.md — Settlement process section
...
SKIM FOR CONTEXT:
- ~/OPENBRAIN/openBrain/ROADMAP.md — Phase 16 for overall context
...
MUST READ:
- ~/OPENBRAIN/openBrain/docs/INCENTED-INTEGRATION.md — Settlement Process Deep Dive section
...
SKIM:
- ~/OPENBRAIN/openBrain/ROADMAP.md — Phase 16 for context
...
| `docs/CLAUDE-CODE-FEEDBACK-PLAN.md` | How to handle feedback |
