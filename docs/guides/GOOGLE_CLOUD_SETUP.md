...
| `docs/guides/GOOGLE_CLOUD_SETUP.md` | `~/OPENBRAIN/openBrain/` | This documentation file |

---

## Related Documentation

- [Google Workspace Integration Plan](../architecture/GOOGLE_WORKSPACE_INTEGRATION_PLAN.md)
- [Open Brain Commands](../process/OPEN_BRAIN_COMMANDS.md)
